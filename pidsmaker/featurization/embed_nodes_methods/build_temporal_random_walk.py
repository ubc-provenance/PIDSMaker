...
def main(cfg):
    ...
    run_temporal_random_walk(
        ...
        out_dir=os.path.join(
            cfg.featurization.embed_nodes.temporal_rw._random_walk_corpus_dir, "train/"
        ),
        cfg=cfg,
    )
    ...
    run_temporal_random_walk(
        ...
        out_dir=os.path.join(
            cfg.featurization.embed_nodes.temporal_rw._random_walk_corpus_dir, "val/"
        ),
        cfg=cfg,
    )
    ...
    run_temporal_random_walk(
        ...
        out_dir=os.path.join(
            cfg.featurization.embed_nodes.temporal_rw._random_walk_corpus_dir, "test/"
        ),
        cfg=cfg,
    )
    ...
    run_temporal_random_walk(
        ...
        out_dir=os.path.join(
            cfg.featurization.embed_nodes.temporal_rw._random_walk_corpus_dir, "unused/"
        ),
        cfg=cfg,
    )
