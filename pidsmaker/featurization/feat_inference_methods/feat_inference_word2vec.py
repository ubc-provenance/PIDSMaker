...
def main(cfg):
    ...
    word2vec_model_path = cfg.feat_training._model_dir + "word2vec.model"
    model = Word2Vec.load(word2vec_model_path)

    decline_percentage = cfg.feat_training.word2vec.decline_rate

    zeros = np.zeros((cfg.feat_training.emb_dim,))
    indexid2vec = {}
