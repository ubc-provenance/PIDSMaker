...
def train_fasttext(corpus, cfg):
    ...
    window_size = cfg.feat_training.fasttext.window_size
    alpha = cfg.feat_training.fasttext.alpha
    min_count = cfg.feat_training.fasttext.min_count
    num_workers = cfg.feat_training.fasttext.num_workers
    negative = cfg.feat_training.fasttext.negative
    use_seed = cfg.feat_training.use_seed
    SEED = 0

    use_pretrained_fb_model = cfg.feat_training.fasttext.use_pretrained_fb_model
