...
def train_feature_word2vec(corpus, cfg, model_save_path):
    ...
    alpha = cfg.featurization.feat_training.feature_word2vec.alpha
    window_size = cfg.featurization.feat_training.feature_word2vec.window_size
    min_count = cfg.featurization.feat_training.feature_word2vec.min_count
    use_skip_gram = cfg.featurization.feat_training.feature_word2vec.use_skip_gram
    num_workers = cfg.featurization.feat_training.feature_word2vec.num_workers
    epochs = cfg.featurization.feat_training.epochs
    compute_loss = cfg.featurization.feat_training.feature_word2vec.compute_loss
    negative = cfg.featurization.feat_training.feature_word2vec.negative
