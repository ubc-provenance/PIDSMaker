...
def save_indexid2msg(indexid2msg, split2nodes, cfg):
    ...
    out_dir = cfg.build_graphs._dicts_dir
...
def compute_and_save_split2nodes(cfg):
    ...
    """
    split_to_files = get_split_to_files(cfg, cfg.build_graphs._graphs_dir)
...
def gen_edge_fused_tw(indexid2msg, cfg):
    ...
    for day in days:
        ...
        for i in range(0, len(timestamps) - 1):
            ...
            temp_list = []
            BATCH = 1024
            window_size_in_ns = cfg.build_graphs.time_window_size * 60_000_000_000
            ...
            for batch_edges in get_batches(events_list, BATCH):
                ...
                if (batch_edges[-1][-2] > start_time + window_size_in_ns) or last_batch:
                    ...
                    date_dir = f"{cfg.build_graphs._graphs_dir}/graph_{day}/"
