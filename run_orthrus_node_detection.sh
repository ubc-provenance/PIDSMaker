...
./run_serial.sh best_model CADETS_E3 --exp=CADETS_E3 --detection.gnn_training.num_epochs=20  && \
...
nohup sh -c "\
./run_serial.sh best_model THEIA_E5 --exp=THEIA_E5 --detection.gnn_training.lr=0.000005 --preprocessing.build_graphs.use_all_files=False && \
