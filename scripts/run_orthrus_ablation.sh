...
nohup sh -c "\
./run_serial.sh orthrus THEIA_E3 --exp=E3_embedding_word2vec --featurization.feat_training.used_method=word2vec && \
./run_serial.sh orthrus THEIA_E5 --exp=E5_embedding_word2vec --featurization.feat_training.used_method=word2vec" &
